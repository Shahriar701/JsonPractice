package com.example.dragonsage.jsonpractice;
    ...
    public class MyAsyncTaskgetNews extends AsyncTask<String, String, String> {
        ...
        protected void onProgressUpdate(String... progress) {
            ...
            try {
                ...
                Toast.makeText(getApplicationContext(), "Sehri: "+sunset+ " " +"Iftar: "+sunrise, Toast.LENGTH_LONG).show();
